...
(
	...
	fk_parent_line		int(11) NULL DEFAULT NULL,
	...
	fk_remise_except	int(11) NULL DEFAULT NULL,
	...
	product_type		INT(11) NULL DEFAULT 0,
	date_start			datetime NULL DEFAULT NULL,
	date_end			datetime NULL DEFAULT NULL,
	info_bits			INT(11) NULL DEFAULT 0,
	buy_price_ht		DOUBLE(24,8) NULL DEFAULT 0,
	fk_product_fournisseur_price	int(11) NULL DEFAULT NULL,
	fk_code_ventilation	int(11) NOT NULL DEFAULT 0,
	fk_export_commpta	int(11) NOT NULL DEFAULT 0,
	special_code		int(10) UNSIGNED NULL DEFAULT 0,
	fk_unit				int(11) NULL DEFAULT NULL,	
