...
/**
 * 	\file		htdocs/management/admin/about.php
 * 	\ingroup	management
 * 	\brief		about page
 */
 ...
 * View
 */
$page_name = $langs->trans("ManagementSetup") . " - " .$langs->trans("About");
llxHeader('', $page_name);
...
dol_fiche_head($head, 'about', $langs->trans("Management"), 0, "management@management");

// About page goes here
print '<table width="100%" cellspacing="5" bgcolor="#E0E0E0">';
print '<tbody>';
print '<tr>';
print '<td rowspan="3" align="center"><a href="http://www.patas-monkey.com"><img src="http://patas-monkey.com/images/patas-monkey_logo.png" alt="" /></a>';
print '<br/>';
print '<b>'.$langs->trans("Slogan").'</b>';
print '</td>';
print '<td align="center" ><a href="http://patas-monkey.com/index.php/fr/modules-dolibarr" target="_blank"> <input style="cursor:pointer; font-family: Happy Monkey; background-color: #ff6600; font-variant: small-caps; font-size: 14px; font-weight: bold; height: 30px; width: 150px;" name="readmore" type="button" value="'.$langs->trans("LienModules").'" /></a>';
print' </td>';
print '<td rowspan="3" align="center">';
print '<b>'.$langs->trans("LienDolistore").'</b><br/>';
print '<a href="http://docs.patas-monkey.com/dolistore" target="_blank"><img border="0" width="180" src="'.DOL_URL_ROOT.'/theme/dolistore_logo.png"></a>';
print '</td>';
print '</tr>';
...
$changelog = @file_get_contents(str_replace("www","dlbdemo",$urlmonkey).'/htdocs/custom/management/changelog.xml',false,$context);
