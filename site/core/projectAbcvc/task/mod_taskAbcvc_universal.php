...
require_once DOL_DOCUMENT_ROOT .'/core/modules/projectAbcvc/task/modules_task.php';


/**
 * 	Classe du modele de numerotation de reference de projet Universal
 */
class mod_taskAbcvc_universal extends ModeleNumRefTask
{
	...
	*/
    function getNextValue($objsoc,$object)
    {
		...
		$numFinal=get_next_value($db,$mask,'abcvc_projet_task','ref','',(is_object($objsoc)?$objsoc->code_client:''),$date);
