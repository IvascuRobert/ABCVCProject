 ...
 */
abstract class ModelePDFProjectsAbcvc extends CommonDocGenerator
{
	var $error='';
 ...
 */
abstract class ModeleNumRefProjectsAbcvc
{
	var $error='';
 ...
 */
function projectAbcvc_pdf_create(DoliDB $db, Project $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0)
{
