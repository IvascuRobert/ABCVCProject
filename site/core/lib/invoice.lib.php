...
function facture_prepare_head($object)
{
	...
	//ABCVC OVERRIDE all  DOL_URL_ROOT
	$h = 0;
	$head = array();

	$head[$h][0] = DOL_URL_ROOT.'/abcvc/compta/facture.php?facid='.$object->id;
	...
	if (empty($conf->global->MAIN_DISABLE_CONTACTS_TAB))
	{
	    ...
	    $head[$h][0] = DOL_URL_ROOT.'/abcvc/compta/facture/contact.php?facid='.$object->id;
	...
	if (! empty($conf->prelevement->enabled))
	{
		...
		$head[$h][0] = DOL_URL_ROOT.'/abcvc/compta/facture/prelevement.php?facid='.$object->id;
    ...
    if (empty($conf->global->MAIN_DISABLE_NOTES_TAB))
    {
    	...
    	$head[$h][0] = DOL_URL_ROOT.'/abcvc/compta/facture/note.php?facid='.$object->id;
	...
	$head[$h][0] = DOL_URL_ROOT.'/abcvc/compta/facture/document.php?facid='.$object->id;
	$head[$h][1] = $langs->trans('Documents');
	if (($nbFiles+$nbLinks) > 0) $head[$h][1].= ' <span class="badge">'.($nbFiles+$nbLinks).'</span>';
	$head[$h][2] = 'documents';
	$h++;

	$head[$h][0] = DOL_URL_ROOT.'/abcvc/compta/facture/info.php?facid='.$object->id;
