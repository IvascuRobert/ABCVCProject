 ...
 */
class abcvcZones // extends CommonObject
{
	...
	*/
	...
	public function fetch($id)
	{
		...
		$sql.= " t.gd";
		//...
		$sql.= " FROM " . MAIN_DB_PREFIX . "abcvc_zones as t";
	...
	public function update($user = 0, $notrigger = 0)
	{
		...
		$sql = "UPDATE " . MAIN_DB_PREFIX . "abcvc_zones SET";
		$sql.= " label=" . (isset($this->label) ? "'" . $this->db->escape($this->label) . "'" : "null") . ",";
		$sql.= " price=" . (isset($this->price) ? "'" . $this->db->escape($this->price) . "'" : "0") . ",";
		$sql.= " kilometers=" . (isset($this->kilometers) ? "'" . $this->db->escape($this->kilometers) . "'" : "0") . ",";
		$sql.= " active=" . (isset($this->active) ? "'" . $this->db->escape($this->active) . "'" : "null") . ",";
		$sql.= " gd=" . (isset($this->gd) ? "'" . $this->db->escape($this->gd) . "'" : "null") . "";
	...
	public function getabcvc($actif = 1) {
