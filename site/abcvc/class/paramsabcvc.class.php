 ...
 */
class Paramsabcvc // extends CommonObject
{
	...
	public function create($user, $notrigger = 0)
	{
		...
		// Insert request
		$sql = "INSERT INTO " . MAIN_DB_PREFIX . "abcvc_params(";
		$sql.= " field1,";
		$sql.= " field2";
		...
		if (! $error) {
			$this->id = $this->db->last_insert_id(MAIN_DB_PREFIX . "abcvc_params");
	...
	public function fetch($id)
	{
		...
		$sql.= " t.field2";
		//...
		$sql.= " FROM " . MAIN_DB_PREFIX . "abcvc_params as t";
	...
	public function update($user = 0, $notrigger = 0)
	{
		...
		// Put here code to add control on parameters values
		// Update request
		$sql = "UPDATE " . MAIN_DB_PREFIX . "abcvc_params SET";
	...
	public function delete($user, $notrigger = 0)
	{
		...
		if (! $error) {
			$sql = "DELETE FROM " . MAIN_DB_PREFIX . "abcvc_params";
			$sql.= " WHERE rowid=" . $this->id;
