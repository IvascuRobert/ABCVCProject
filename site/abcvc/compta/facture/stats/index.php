...
require_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/facture/class/facturestats.class.php';
...
$h=0;
$head = array();
$head[$h][0] = DOL_URL_ROOT . SUPP_PATH.'/compta/facture/stats/index.php?mode='.$mode;
