...
require_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/deplacement/class/deplacementstats.class.php';
...
$h=0;
$head = array();
$head[$h][0] = DOL_URL_ROOT . SUPP_PATH.'/compta/deplacement/stats/index.php';
