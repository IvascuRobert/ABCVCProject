...
if ($result)
{
    ...
    while ($i < min($num,$limit))
    {
        ...
        print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/prelevement/ligne.php?id='.$obj->rowid_ligne.'">';
        ...
        print '<td><a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture.php?facid='.$obj->facid.'">';
        print img_object($langs->trans("ShowBill"),"bill");
          print '&nbsp;<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture.php?facid='.$obj->facid.'">'.$obj->facnumber."</a></td>\n";
        print '</a></td>';
