...
require_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/prelevement/class/bonprelevement.class.php';
require_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/prelevement/class/ligneprelevement.class.php';
require_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/prelevement/class/rejetprelevement.class.php';
...
$h = 0;
$head[$h][0] = DOL_URL_ROOT.SUPP_PATH.'/compta/prelevement/ligne.php?id='.$id;
...
if ($id)
{
	...
	if ($result)
	{
		...
		while ($i < min($num,$conf->liste_limit))
		{
			...
			print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture.php?facid='.$obj->facid.'">';
			print img_object($langs->trans("ShowBill"),"bill");
			print '</a>&nbsp;';

			print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture.php?facid='.$obj->facid.'">'.$obj->ref."</a></td>\n";
