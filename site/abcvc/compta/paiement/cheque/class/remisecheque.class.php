...
class RemiseCheque extends CommonObject
{
	...
	function load_board($user)
	{
		...
		if ($resql)
		{
			...
			$response->url=DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/cheque/index.php?leftmenu=checks&amp;mainmenu=bank';
	...
	function getNomUrl($withpicto=0,$option='')
	{
        ...
        $link = '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/cheque/card.php?id='.$this->id.'" title="'.dol_escape_htmltag($label, 1).'" class="classfortooltip">';
		$linkend='</a>';
