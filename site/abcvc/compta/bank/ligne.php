...
// Load bank groups
require_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/bank/class/bankcateg.class.php';
...
$tabs = array(
    array(
        DOL_URL_ROOT.SUPP_PATH.'/compta/bank/ligne.php?rowid='.$rowid,
        $langs->trans('Card')
    ),
    array(
        DOL_URL_ROOT.SUPP_PATH.'/compta/bank/info.php?rowid='.$rowid,
        $langs->trans('Info')
    )
);
...
if ($result)
{
    ...
    if ($db->num_rows($result))
    {
        ...
        $linkback = '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/bank/bankentries.php">'.$langs->trans("BackToList").'</a>';
        ...
        if (count($links))
        {
            ...
            foreach($links as $key=>$val)
            {
                ...
                if ($links[$key]['type']=='payment') {
                    print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/card.php?id='.$links[$key]['url_id'].'">';
                    ...
                    print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/sociales/card.php?id='.$links[$key]['url_id'].'">';
                    ...
                    print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/payment_sc/card.php?id='.$links[$key]['url_id'].'">';
                    print img_object($langs->trans('ShowPayment'),'payment').' ';
                    print $langs->trans("SocialContributionPayment");
                    print '</a>';
                }
                else if ($links[$key]['type']=='payment_vat') {
                    print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/tva/card.php?id='.$links[$key]['url_id'].'">';
                    print img_object($langs->trans('ShowVAT'),'payment').' ';
                    print $langs->trans("VATPayment");
                    print '</a>';
                }
                else if ($links[$key]['type']=='payment_salary') {
                    print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/salaries/card.php?id='.$links[$key]['url_id'].'">';
                    ...
                    print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/bank/ligne.php?rowid='.$links[$key]['url_id'].'">';
        ...
        if ($user->rights->banque->modifier || $user->rights->banque->consolidate)
        {
            ...
            if ($objp->receiptid)
            {
                include_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/paiement/cheque/class/remisecheque.class.php';
        ...
        if ($acct->canBeConciliated() > 0)  // Si compte rapprochable
        {
            ...
            if ($user->rights->banque->consolidate)
            {
                ...
                if ($objp->num_releve) print ' &nbsp; (<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/bank/releve.php?num='.$objp->num_releve.'&account='.$acct->id.'">'.$langs->trans("AccountStatement").' '.$objp->num_releve.')</a>';
                print '</td>';
            }
            else
            {
