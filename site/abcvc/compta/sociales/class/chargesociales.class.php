...
class ChargeSociales extends CommonObject
{
    ...
    function delete($user)
    {
        ...
        include_once DOL_DOCUMENT_ROOT.SUPP_PATH.'/compta/bank/class/account.class.php';
    ...
    function getNomUrl($withpicto=0,$maxlen=0)
    {
        ...
        $link = '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/sociales/card.php?id='.$this->id.'" title="'.dol_escape_htmltag($label, 1).'" class="classfortooltip">';
        $linkend='</a>';
