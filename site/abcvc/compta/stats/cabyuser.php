...
if (count($amount)) {
	...
	// Amount w/o VAT
        ...
        {
            if ($key > 0) {
		print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/list.php?userid='.$key.'">';
		} else {
		    print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/list.php?userid=-1">';
		}
        } else {
            if ($key > 0) {
		print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture/list.php?userid='.$key.'">';
	    } else {
		print '<a href="#">';
	    }
	    ...
	    print '&nbsp;<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture/stats/index.php?userid='.$key.'">'.img_picto($langs->trans("InvoiceStats"),"stats").'</a>&nbsp;';
	}
        print '</td>';
        print "</tr>\n";
        $i++;
