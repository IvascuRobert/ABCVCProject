...
if (count($amount)) {
	...
	foreach($arrayforsort as $key=>$value) {
		...
		if ($modecompta != 'CREANCES-DETTES') {
                    if ($key > 0) {
			print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/list.php?socid='.$key.'">';
		    } else {
			print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/list.php?socid=-1">';
		    }
		} else {
		    if ($key > 0) {
			print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture/list.php?socid='.$key.'">';
		    } else {
			print '<a href="#">';
		    }
		...
		if ($modecompta != 'CREANCES-DETTES') {
			...
			print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/paiement/list.php?orphelins=1">';
		    }
		} else {
                    if ($key > 0) {
                        print '<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture/list.php?socid='.$key.'">';
	    ...
	    print '&nbsp;<a href="'.DOL_URL_ROOT.SUPP_PATH.'/compta/facture/stats/index.php?socid='.$key.'">'.img_picto($langs->trans("InvoiceStats"),"stats").'</a>&nbsp;';
	}
        print '</td>';
	print "</tr>\n";
	$i++;
