...
class ProjectABCVC extends CommonObject
{
    ...
    function getNomUrl($withpicto=0, $option='', $addlabel=0, $moreinpopup='', $sep=' - ', $notooltip=0)
    {
        ...
        if ($option != 'nolink')
        {
            ...
            {
                $url = DOL_URL_ROOT . '/abcvc/projet/tasks.php?id=' . $this->id;
            }
            else
            {
                $url = DOL_URL_ROOT . '/abcvc/projet/card.php?id=' . $this->id;
            }
        }
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <!-- PROJECTS -->
                        <div class="btn-group">
                            <a href="/abcvc/projet/card.php?id=<?php echo $id_project?>" class="btn btn-primary">Project</a>
