...
<form name="addtime" method="POST" action="<?php echo $_SERVER["PHP_SELF"].($project->id > 0 ? '?id='.$project->id : ''); ?>">
    ...
    ?>
    <input type="hidden" name="addtimeyear" value="<?php echo $tmp['year']; ?>">
    <input type="hidden" name="addtimemonth" value="<?php echo $tmp['mon']; ?>">
    <input type="hidden" name="addtimeday" value="<?php echo $tmp['mday']; ?>">
                ...
                <div class="panel panel-primary filterable">
                            <div class="panel-heading">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                             echo $langs->trans("ProjectsDesc").($onlyopenedproject?' '.$langs->trans("OnlyOpenedProject"):''); 
                                            }
                                ...
                                <div class="div-table-responsive">
                                        <table class=" table table-responsive tagtable liste<?php echo ($moreforfilter?" listwithfilterbefore":""); ?>" id="tablelines3"><?php echo "\n"; ?>
                                            ...
                                            <div class="floatright"><?php echo $nav; ?></div><?php     // We move this before the assign to components so, the default submit button is not the assign to.?>
                                            ...
                                            <tr class="liste_titre">
                                                ...
                                                ?>
                                                <td align="right" class="maxwidth100"><?php echo $langs->trans("PlannedWorkload"); ?></td>
                                                <td align="right" class="maxwidth100"><?php echo $langs->trans("ProgressDeclared"); ?></td>
                                                <td align="right" class="maxwidth100"><?php echo $langs->trans("TimeSpent"); ?></td>
                                                <?php
                                                if ($usertoprocess->id == $user->id) {
                                                    ?>

                                                <td align="right" class="maxwidth100"><?php echo $langs->trans("TimeSpentByYou"); ?></td><?php
                                                }
                                                else {
                                                    ?>
                                                    <td align="right" class="maxwidth100"><?php echo $langs->trans("TimeSpentByUser"); ?></td><?php
                                                    }
                                                    ?>
                                                <td align="center"><?php echo $langs->trans("HourStart"); ?></td>
                                                
                                                <!-- <td align="center" colspan="2"><?php //echo $langs->trans("Duration"); ?></td> -->
                                                <td colspan="3" align="center"><?php echo $langs->trans("Note"); ?></td>
                                            </tr>
                                            <?php echo "\n"; ?>
                                            ...
                                            <tr class="liste_titre">
                                                ...
                                                if (! empty($conf->global->PROJECT_LINES_PERDAY_SHOW_THIRDPARTY)) 
                                                    ...
                                                    <td class="liste_titre"><input type="text" size="4" name="search_thirdparty" value="<?php echo dol_escape_htmltag($search_thirdparty); ?>"></td>
                                                    <?php 
                                                    }
                                                    ?>
                                            ...
                                            {
                                                ?>
                                                <tr><td colspan="10"><?php echo $langs->trans("NoTasks"); ?></td></tr><?php
                                            }
                                            ?>
                                        </table>
                                            <div class="center">
                                                <input type="submit" class="button"<?php echo ($disabledtask?' disabled':''); ?> value="<?php echo $langs->trans("Save"); ?>">
                                            </div>
                                </div>
