...
class MyBox extends ModeleBoxes
{
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/humbert/class/humbert.class.php";
		...
		$this->info_box_head = array(
			...
			'subpicto' => 'object_humbert@humbert',
