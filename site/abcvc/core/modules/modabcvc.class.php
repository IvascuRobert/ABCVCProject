...
/**
 * \defgroup    humbert    humbert module
 * \brief       humbert module descriptor.
 *
 * Put detailed description here.
 */

/**
 * \file        core/modules/modhumbert.class.php
 * \ingroup     humbert
...
/**
 * Description and activation class for module humbert
 */
class modabcvc extends DolibarrModules
{
...
//        )
	...
	public $descriptionlong = "TODO Description longue (HTML)";

	/**
	 * @var string Module editor name
	 * @since 4.0
	 */
	public $editor_name = "Mac2";

	/**
	 * @var string Module editor website
	 * @since 4.0
	 */
	public $editor_url = "http://www.lmk-dev.eu";
	 ...
	 */
	public $version = 'stable'; //development

	/** @var string Key used in llx_const table to save module status enabled/disabled */
	public $const_name = 'MAIN_MODULE_ABCVC';

	/**
	 * @var string Module logo
	 * Should be named abcvc@object_mymodule.png and store under abcvc/img
	 */
	public $picto = 'mymodule@abcvc';

	/** @var array Define module parts */
	public $module_parts = array(
		/** @var bool Module ships triggers in humbert/core/triggers */
		'triggers' => false,
		/**
		 * @var bool Module ships login in humbert/core/login
		 * @todo: example
		 */
		'login' => false,
		/**
		...
		'menus' => false,
		/**
		 * @var bool Module ships theme in abcvc/theme
		 * @todo example
		 */
		'theme' => false,
		/**
		 * @var bool Module shipped templates in abcvc/core/tpl overload core ones
		 * @todo example
		 */
		'tpl' => false,
		/**
	...
	public $config_page_url = 'setup.php@abcvc';
	...
	public $langfiles = array('abcvc@abcvc');
	...
	public function __construct($db)
	{
		...
		//$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@humbert:$user->rights->humbert->read:/humbert/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@humbert:$user->rights->othermodule->read:/humbert/mynewtab2.php?id=__ID__',
		...
		// Dictionaries
		if (! isset($conf->humbert->enabled)) {
			$conf->humbert=new stdClass();
			$conf->humbert->enabled = 0;
		}
		//$this->dictionaries = array();
		/* Example:
		  $this->dictionaries=array(
			  'langs'=>'humbert@humbert',
		...
		// Permission id (must not be already used)
		$this->rights[0][0] = 7000;
		$this->rights[0][1] = 'Lire les projets et taches';
		$this->rights[0][2] = 'r';
		$this->rights[0][3] = 0;
		$this->rights[0][4] = 'read';

		$this->rights[1][0] = 7001;
		$this->rights[1][1] = 'Creer/modifier les projets et taches';
		$this->rights[1][2] = 'w';
		$this->rights[1][3] = 0;
		$this->rights[1][4] = 'write';

		$this->rights[2][0] = 7002;
		$this->rights[2][1] = 'Visualiser tous les utilisateurs sur projet';
		$this->rights[2][2] = 'r';
		$this->rights[2][3] = 0;
		$this->rights[2][4] = 'readuser';

		$this->rights[3][0] = 7003;
		$this->rights[3][1] = 'Gérer les temps';
		$this->rights[3][2] = 'w'; // p ???
		$this->rights[3][3] = 0;
		$this->rights[3][4] = 'timespentadmin';

		$this->rights[4][0] = 7004;
		$this->rights[4][1] = 'Saisir des temps (partagés ou dont je suis affecte)';
		$this->rights[4][2] = 'w'; // s ???
		$this->rights[4][3] = 0;
		$this->rights[4][4] = 'timespent';
		...
		$this->menu[0]=array(
			...
			'leftmenu'=>'abcvc',
			'url'=>'/abcvc/cpanel.php',
			// Lang file to use (without .lang) by module.
			// File must be in langs/code_CODE/ directory.
			'langs'=>'abcvc',
			'position'=>100,
			// Define condition to show or hide menu entry.
			// Use '$conf->abcvc->enabled' if entry must be visible if module is enabled.
			'enabled'=>'$conf->abcvc->enabled',
			// Use 'perms'=>'$user->rights->abcvc->level1->level2'
		...
		// This menu's leftmenu ID
			...
			$this->menu[2]=array(
				...
				'mainmenu'=>'abcvc',
				'leftmenu'=>'abcvc',
				'url'=>'/abcvc/abcvc.php?action=create',
				'langs'=>'abcvc',
				'position'=>100,
				'enabled'=>'$conf->abcvc->enabled',
				'perms'=>'1',
		...
		// This menu's leftmenu ID
			...
			$this->menu[4]=array(
				'fk_menu'=>'r=3',
				'type'=>'left',
				'titre'=>'Nouvelle concentration',
				'mainmenu'=>'abcvc',
				'leftmenu'=>'abcvc',
				'url'=>'/abcvc/concentration.php?action=create',
				'langs'=>'abcvc',
				'position'=>100,
				'enabled'=>'$conf->abcvc->enabled',
				'perms'=>'1',
		...
		//	'type'=>'left',
		// Menu's title. FIXME: use a translation key
		//	'titre'=>'abcvc left menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'mainmenucode',
		// This menu's leftmenu ID
		//	'leftmenu'=>'abcvc',
		//	'url'=>'/abcvc/pagelevel2.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /abcvc/sql/
	...
	{
		return $this->_load_tables('/abcvc/sql/');
	}
	...
	public function remove($options = '')
	{
		...
		$sql[] = "DROP TABLE IF EXISTS `llx_abcvc_params`";
		$sql[] = "DROP TABLE IF EXISTS `llx_abcvc_matiere`";
		$sql[] = "DROP TABLE IF EXISTS `llx_abcvc_concentrations`";

		$sql[] = "DELETE FROM `llx_const` WHERE name like '%abcvc_%'";
