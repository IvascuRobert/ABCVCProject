...
//DOL_DOCUMENT_ROOT."/projet/class/project.class.php", 
			DOL_DOCUMENT_ROOT."/abcvc/projet/class/project.class.php", 
...
//'Project',
	    ...
	    $links=array(
	        ...
	        DOL_URL_ROOT.'/abcvc/projet/index.php?mainmenu=abcvc',
...
if (! empty($conf->projet->enabled) && $user->rights->projet->lire)
{
    ...
    include_once DOL_DOCUMENT_ROOT.'/abcvc/projet/class/project.class.php';
    $board=new ProjectABCVC($db);
